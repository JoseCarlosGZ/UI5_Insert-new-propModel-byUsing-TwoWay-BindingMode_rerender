		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#josecarlosgzsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecarlosgzsapui5-display": {
								"semanticObject": "josecarlosgzsapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=josecarlosgz.sapui5",
									"url": sap.ui.require.toUrl("josecarlosgz/sapui5")
								}
							}
						}
					}
